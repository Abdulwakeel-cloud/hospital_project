...
if (isset($_POST['submit'])) {
    ...
    // Image logic
    $image_uploaded = !empty($_FILES['img']['name']) && $_FILES['img']['error'] === UPLOAD_ERR_OK;
    $new_img_name = null;
    ...
    if ($image_uploaded) {
        ...
        if (!in_array($img_extension, $allowed)) {
            ...
            $new_img_name = uniqid('post', true) . '.' . $img_extension;
        ...
        try {
            ...
            if ($image_uploaded) {
                ...
                if (move_uploaded_file($_FILES['img']['tmp_name'], $targetPath)) {
                    ...
                    // Delete old image
                    if (!empty($posts->image) && file_exists($upload_dir . $posts->image)) {
                        unlink($upload_dir . $posts->image);
                    }
            ...
            <div class="row justify-content-center">
              <div class="col-12 col-md-8 col-lg-6">
                ...
                <div class="form-outline mb-4 mt-4">     
                  <input type="title" name="title" id="form2Example1" class="form-control" placeholder="Enter your title" value="<?php echo htmlspecialchars($posts->title) ?>"/>
                 
                </div>
                <div class="form-outline mb-4 mt-4">
                  <input type="subtitle" name="subtitle" id="form2Example1" class="form-control" placeholder="Enter your subtitle" value="<?php echo htmlspecialchars($posts->subtitle) ?>"/>
                 
                </div>
                <div class="form-outline mb-4 mt-4">
                  <textarea name="body" placeholder="Post Content" rows="8"><?php echo htmlspecialchars($posts->body) ?></textarea><br>
                </div>
