...
if (isset($_POST["submit"])) {
    ...
    if (empty($errors)) {
        try {
            $stmt = $db->prepare("INSERT INTO testimonials (name, profession, message, image, created_at) VALUES (:name, :profession, :message, :image, NOW())");
            ...
            if ($new_img_name && !empty($img_tmp_name)) {
            ...
            $success = "Testimonial added successfully! Redirecting...";
    ...
    <div class="card p-4">
      ...
      <form action="" method="POST" enctype="multipart/form-data">
        ...
        <div class="mb-3">
          ...
          <input type="text" name="profession" id="profession" class="form-control" required value="<?php echo htmlspecialchars($_POST['profession'] ?? ''); ?>">
        </div>
        <div class="mb-3">
          <label for="message" class="form-label">Message</label>
          <textarea name="message" id="message" rows="4" class="form-control" required><?php echo htmlspecialchars($_POST['message'] ?? ''); ?></textarea>
        </div>
        <div class="mb-3">
          <label for="img" class="form-label">Patient Image (optional)</label>
          <input type="file" name="img" id="img" class="form-control">
        </div>
        <button type="submit" name="submit" class="btn btn-primary">Save Testimonial</button>
      </form>
    </div>
  </div>
